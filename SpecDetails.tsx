  ...
  return (
    <li className="my-1">
      <div
        ...
        } ${!isFolder && hasChildren === false ? 'hover:bg-gray-100/50' : ''}`}
        style={{ paddingLeft: `${1 + level * 1.5}rem` }}
      >
        <span className="flex-grow text-gray-700 select-none">{item.name}</span>
        {hasChildren && (
          <svg
    ...
    return (
        <div className="w-full h-full flex flex-col bg-white rounded-lg shadow-xl border border-gray-200 overflow-hidden">
            <div className="p-4 border-b border-gray-200">
                <h2 className="text-xl font-semibold text-gray-900">System Specification Details</h2>
                <p className="text-sm text-gray-500">Live operational structure of the JaxAI Hub.</p>
            </div>
