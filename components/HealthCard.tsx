...
const StatusItem: React.FC<{ label: string; isOk: boolean }> = ({ label, isOk }) => (
        ...
        <div className="p-4">
            ...
            <div className="space-y-3">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    <span className="text-gray-300">Last Tick Received: <span className="font-mono text-white">{new Date(health.last_tick_ts).toLocaleTimeString()}</span></span>
                </div>
